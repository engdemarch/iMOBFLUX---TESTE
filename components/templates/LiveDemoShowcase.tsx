...
// próprio preview. Só existe um tenant demo hoje (template clássico); a
// galeria estática em TemplatePreview cobre a comparação entre templates.
    ...
    <div>
      ...
      <div
        className={`mx-auto border border-[#DEE2E7] rounded-[10px] overflow-hidden shadow-xl bg-white transition-all duration-300 ${
          viewport === 'desktop' ? 'max-w-4xl' : 'max-w-[380px]'
        }`}
      >
        <div className="h-10 bg-[#F2F4F6] border-b border-[#DEE2E7] flex items-center gap-3 px-4">
          <div className="flex items-center gap-1.5 shrink-0">
            <span className="w-2.5 h-2.5 rounded-full bg-[#DEE2E7]" />
            <span className="w-2.5 h-2.5 rounded-full bg-[#DEE2E7]" />
            <span className="w-2.5 h-2.5 rounded-full bg-[#DEE2E7]" />
          </div>
          <div className="flex-1 bg-white border border-[#DEE2E7] rounded-full px-3 py-1 text-[11px] text-[#68707C] text-center truncate">
